...
public class VisilabsReachability {

    public typealias NetworkReachable = (VisilabsReachability) -> ()
    public typealias NetworkUnreachable = (VisilabsReachability) -> ()
...
public extension VisilabsReachability {
...
fileprivate extension VisilabsReachability {
...
extension SCNetworkReachabilityFlags {
    ...
    typealias Connection = VisilabsReachability.Connection
...
private class ReachabilityWeakifier {
    weak var reachability: VisilabsReachability?
    init(reachability: VisilabsReachability) {
