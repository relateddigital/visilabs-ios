    ...
    ;(function(factory) {
        ...
        EasyWheel.prototype.initialize = function() {
            ...
            if ($.trim(self.o.type) !== 'color') {
                ...
                //+ '<path fill="' + self.o.markerColor
                //+ '" d="M40,0C22.4,0,8.2,17.7,8.2,39.4S40,115,40,115s31.8-53.9,31.8-75.6S57.6,0,40,0z M40,52.5 c-5.6,0-10-5.6-10-12.4s4.5-12.4,10-12.4s10,5.6,10,12.4S45.6,52.5,40,52.5z"/>'
                //+ '<path fill="rgba(0, 0, 0, 0.3)" d="M40,19.2c-9.3,0-16.9,9.3-16.9,20.8S30.7,60.8,40,60.8S56.9,51.5,56.9,40S49.3,19.2,40,19.2z M40,52.5 c-5.6,0-10-5.6-10-12.4s4.5-12.4,10-12.4s10,5.6,10,12.4S45.6,52.5,40,52.5z"/>'
                ...
                /*
                Layermarker.append('<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 80 115" style="enable-background:new 0 0 80 115;" xml:space="preserve">'
                + '<g>' + '<path fill="' + self.o.markerColor
        ...
        $.fn.easyWheel = function() {
            ...
            return self;
                    ...
                    SpinToWin.prototype.createItems = function () {
                      ...
                      for (; i < this.config.slices.length; i++) {
                        this.config.items.push({
                          id: i, name: this.config.slices[i].displayName
                      ...
                      if (this.config.sliceCount > this.config.slices.length) {
                        while (this.config.items.length < this.config.sliceCount) {
                          ...
                          this.config.items.push({
                            id: i, name: this.config.slices[sliceId].displayName
                    ...
                    SpinToWin.prototype.createEasyWheel = function () {
                      this.config.easyWheel = $('#canvas-container').easyWheel({
                        ...
                        sliceLineWidth: 0,
                        outerLineWidth: 5,
                        centerImage : 'https://imgvisilabsnet.azureedge.net/spin_to_win/uploaded_images/163_1100_130_20210405151937177.png',
                        centerWidth: 20,
                        centerLineWidth: 5,
                        centerImageWidth: 20,
                        textColor: "#fff",
                        markerColor: this.config.buttonColor,
                        centerLineColor: "rgb(255, 255, 255)",
                        centerBackground: "rgb(255, 255, 255)",
                        sliceLineColor: "rgb(255, 255, 255)",
                        outerLineColor: "rgb(255, 255, 255)",
                        random: false,
                        onStart: function (results, spinCount, now) {
                    ...
                    SpinToWin.prototype.styleHandler = function () {
                      ...
                      //this.canvasContainer.style.bottom = (-wheelCanvasHeight / 2) + "px";//TODO:
                      this.canvasContainer.style.bottom = ((-wheelCanvasHeight / 2) + 40) + "px";//TODO:
