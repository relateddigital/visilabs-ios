...
public class VisilabsCarouselNotificationViewController: VisilabsBasePageViewController, ItemControllerDelegate {
    ...
    fileprivate func configureThumbnailsButton() {
        ...
        if let thumbnailsButton = thumbnailsButton {
            thumbnailsButton.addTarget(self, action: #selector(VisilabsCarouselNotificationViewController.showThumbnails), for: .touchUpInside)
    ...
    fileprivate func configureDeleteButton() {
        ...
        if let deleteButton = deleteButton {
            deleteButton.addTarget(self, action: #selector(VisilabsCarouselNotificationViewController.deleteItem), for: .touchUpInside)
...
/*
class VisilabsCarouselNotificationViewController: VisilabsBaseNotificationViewController {
    ...
    convenience init(notification: VisilabsInAppNotification) {
        self.init(notification: notification,
                  nameOfClass: String(describing: VisilabsCarouselNotificationViewController.notificationXibToLoad()))
    }

    static func notificationXibToLoad() -> String {
        let xibName = String(describing: VisilabsCarouselNotificationViewController.self)
...
extension VisilabsCarouselNotificationViewController: UIScrollViewDelegate {
