...
class VisilabsTargetingAction {
    ...
    private func parseSpinToWin(_ spinToWin: [String: Any?]) -> SpinToWinViewModel? {
        ...
        let promocodes_soldout_message_text_color = extendedProps[VisilabsConstants.promocodes_soldout_message_text_color] as? String ?? ""
        let promocodes_soldout_message_font_family = extendedProps[VisilabsConstants.promocodes_soldout_message_font_family] as? String ?? ""
        let promocodes_soldout_message_text_size = extendedProps[VisilabsConstants.promocodes_soldout_message_text_size] as? String ?? ""
        let promocodes_soldout_message_background_color = extendedProps[VisilabsConstants.promocodes_soldout_message_background_color] as? String ?? ""
